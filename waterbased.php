...
?>
    ...
    <div class="panel-heading">
      <h3 class="panel-title">WATERBASED</h3>
    </div>
...
<div class="container">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                // cek jka semua ok,
                    ...
                    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                        ...
                        // Redirect ke waterbased.php setelah sukses upload
                        header("Location: waterbased.php");
                        exit();
                    } else {
            ...
            <p><a href="waterbased.php" class="btn btn-default">Kembali ke Halaman Utama</a></p>
        </div>
    </div>
</div>
<?php
